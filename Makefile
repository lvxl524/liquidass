...
$(TWEAK_NAME)_CFLAGS = -fobjc-arc -fvisibility=default -Wno-gnu-folding-constant -DLG_PACKAGE_VERSION=@\"$(LG_PACKAGE_VERSION)\" -DLG_BUILD_TIMESTAMP=@\"$(LG_BUILD_TIMESTAMP)\"
